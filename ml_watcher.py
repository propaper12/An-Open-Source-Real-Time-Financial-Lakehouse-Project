...
# DİKKAT: Spark 's3a' kullanır ama bu kütüphane 's3' ister!
DATA_PATH = "s3://market-data/silver_layer_delta"

# MinIO Bağlantı Ayarları (Bekçinin gözlüğü)
storage_options = {
    "AWS_ACCESS_KEY_ID": "admin",
    "AWS_SECRET_ACCESS_KEY": "admin12345",
    "AWS_ENDPOINT_URL": "http://minio:9000",
    "AWS_REGION": "us-east-1",
    "AWS_S3_ALLOW_UNSAFE_RENAME": "true", # MinIO için kritik ayar
    "AWS_ALLOW_HTTP": "true"
}

print(f"🕵️‍♂️ ML Watcher v3.0 (Fixed) Başladı - Hedef: {MIN_ROWS_TO_START} Satır")
...
def get_row_count():
    ...
    try:
        ...
        # print(f"⚠️ Okuma Hatası (Henüz veri yok mu?): {e}") 
        return 0
