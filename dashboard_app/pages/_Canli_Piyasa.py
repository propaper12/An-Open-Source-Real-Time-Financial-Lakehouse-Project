...
with st.sidebar:
    ...
    try:
        ...
        if container.status == 'running':
            ...
            if st.button("▶️ Başlat"): container.start(); st.rerun()
    except:
...
if df.empty:
    ...
    if len(available_symbols) > 0:
        ...
        if not df_chart.empty:
            ...
            # --- TARİH VE SAAT KISMI (GERİ GELDİ) ---
# Sadece Yıl-Ay-Gün Saat:Dakika:Saniye formatını al (Küsüratı at)
